...
- [A) Station Prompts](#tables-a)
- [B) Architecture of Success](#tables-b)
- [C) Big Book of Glitches](#tables-c)
- [D) Commute Back Success](#tables-d)
- [E) Recharge Prompts](#tables-e)
- [F) Battery Zero Events](#tables-f)
- [G) Objective Prompt Tables](#tables-g)
...
Use after Success on standard pool checks.
Pick the pool table that was rolled.
